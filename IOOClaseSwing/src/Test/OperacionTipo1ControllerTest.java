...
public class OperacionTipo1ControllerTest {
    ...
    public void save_t1_success() throws Exception {
        ...
        Tipo1 operacion = new Tipo1(5000, LocalDate.now(), LocalDate.parse("06/30/2021"), subtipo,"1111111", 0.15f);
    ...
    public void save_t2_success() throws Exception {
        ...
        Tipo2 operacion = new Tipo2(5000,LocalDate.now(), LocalDate.parse("06/30/2021"), subtipo, "empresa2");
    ...
    public void save_t3_success() throws Exception {
        ...
        Tipo3 operacion = new Tipo3(45678,LocalDate.now(),LocalDate.parse("2022-06-06",formato),subtipo,"Santander",0.08f,LocalDate.now(),18,"frances");
